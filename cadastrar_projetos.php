...
<body>
    ...
    <input class="form-control"  type="text" name="email_autor" placeholder="Insira o e-mail do autor do projeto" >
    <label class="badge badge-secondary">Telefone do autor:</label><br>
    <input class="form-control"  type="text" name="fone_autor" placeholder="Insira o telefone do autor do projeto" >
    ...
    <input class="form-control" type="email" name="email_orientadorcol" placeholder="Insira o e-mail do orientador" >
    <label class="badge badge-secondary">E-mail do Orientador:</label><br>
    ...
    <input class="form-control" type="tel" name="fone_orientador" placeholder="(DDD)XXXX-XXXX Insira o telefone do orientador" >
            </section>
        ...
        <tr><th><input class="form-control" type="text" id="nome_coautor" name="Coautor[]" required />
        ...
        <td><center><input type="radio" name="apresentador_projeto" value ='1'></center></td>
    </th></tr>
        </table>
    </div>
    </div>
